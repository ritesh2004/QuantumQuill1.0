            ...
            <div class="w-full max-w-sm bg-[#1d232a] border border-gray-700 rounded-lg shadow-lg" data-aos="fade-up" data-aos-duration="1000">
                <div class="flex flex-col items-center py-10">
                    ...
                    <div className='w-full px-5'>
                        <input type="text" id="username" className="bg-[#424f5f] w-[90%] border border-gray-700 text-white text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full px-5 py-3 mt-4" value={username} onChange={(e)=>setUsername(e.target.value)} />
                    </div>
                    <div className='w-full px-5'>
                        <input type="text" id="bio" className="bg-[#424f5f] w-[90%] border border-gray-700 text-white text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full px-5 py-3 mt-4" value={bio} onChange={(e)=>setBio(e.target.value)} />
                    </div>
