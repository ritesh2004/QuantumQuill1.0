        ...
        <div style={{ fontFamily: 'Montserrat' }} data-aos="zoom-in-up">
            <div class="relative max-w-sm bg-white border border-gray-200 rounded-lg shadow w-[360px] h-[380px] md:h-[400px]">
                ...
                <div class="relative p-5">
                    <h5 class="w-full mb-2 text-2xl font-bold tracking-tight text-gray-900 flex justify-between">{props.title?.slice(0, 20)}... <span className='p-2 rounded-full cursor-pointer hover:bg-gray-300' onClick={() => setOpen(!open)}>
